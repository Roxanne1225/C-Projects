...
class BinaryTree
{
    public:
         ...
         */
        // BinaryTree swappp(Node *root);
      //  BinaryTree *retree(Node *root);
      void mirror(Node *root);
         ...
         */
          int numNodes(Node *root) const;
          void storePath(std::vector<std::vector<T>>& paths, std::vector<T> path, int curNum, int *start) const;
          void getPathRecur(Node *root, std::vector<std::vector<T>>& paths, std::vector<T>& path, int *start, int curNum) const;
         ...
         */
         int sumDistances(Node *root) const;
